...
bigonesorting_dir = (
    camp_root / "A1_MAPseq/FIAA32.6a/Sequencing/Processed_data/BC_split/temp/bigones"
)
...
# UMIprocessthechunks(directory=bigonesorting_dir, toread=barcodenum)
UMIprocesstheminlots(
    newdir=bigonesorting_dir, barcodenum=barcodenum, numberdivisions=num
)
