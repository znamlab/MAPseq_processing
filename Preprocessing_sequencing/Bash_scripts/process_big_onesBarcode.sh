#!/bin/sh
# Job name
#SBATCH --job-name=takethesmallones_barcode
...
# Notifications
#SBATCH --output=/camp/home/turnerb/slurm_logs/BCBatch/takethesmallones_barcode_%j.out
#SBATCH --error=/camp/home/turnerb/slurm_logs/BCBatch/takethesmallones_barcode_%j.err
...
cd /camp/home/turnerb/home/shared/code/MAPseq_processing/AC_MAPseq/Brain1_FIAA32.6a/New_with_UMItools/160223/files/
python Call_functions_BC.py $1
echo "Done"
