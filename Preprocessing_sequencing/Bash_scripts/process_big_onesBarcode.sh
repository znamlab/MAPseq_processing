...
# Notifications
#SBATCH --output=/camp/home/turnerb/slurm_logs/BCBatch/2mill_takethesmallones_barcode_%j.out
#SBATCH --error=/camp/home/turnerb/slurm_logs/BCBatch/2mill_takethesmallones_barcode_%j.err
