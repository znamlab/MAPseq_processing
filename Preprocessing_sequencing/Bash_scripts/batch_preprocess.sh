#!/bin/sh
# Job name
#SBATCH --job-name=batch_process_050423
...
# Notifications
#SBATCH --output=/camp/home/turnerb/slurm_logs/April23/050423batchprocess_%j.out
#SBATCH --error=/camp/home/turnerb/slurm_logs/April23/050423batchprocess_%j.err
...
python call_functions_preprocess_seq.py
echo "Done"
