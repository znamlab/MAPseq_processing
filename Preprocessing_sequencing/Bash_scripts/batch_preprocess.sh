#!/bin/sh
# Job name
#SBATCH --job-name=batch_process_260323
...
# Notifications
#SBATCH --output=/camp/home/turnerb/slurm_logs/March23/batchprocess_%j.out
#SBATCH --error=/camp/home/turnerb/slurm_logs/March23/batchprocess_%j.err
