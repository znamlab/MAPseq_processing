#!/bin/sh
# Job name
#SBATCH --job-name=030423_sample_splitting
...
# Notifications
#SBATCH --output=/camp/home/turnerb/slurm_logs/April23/030423_splitting_preprocess_%j.out
#SBATCH --error=/camp/home/turnerb/slurm_logs/April23/030423_splitting_preprocess_%j.err
