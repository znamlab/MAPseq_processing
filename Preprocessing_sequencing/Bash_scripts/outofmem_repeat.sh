#!/bin/sh
# Job name
#SBATCH --job-name=outofmem_repeattakethesmallones_UMI
...
#SBATCH --error=/camp/home/turnerb/slurm_logs/BCBatch/180223/outofmem_repeattakethesmallones_UMI_%j.err
